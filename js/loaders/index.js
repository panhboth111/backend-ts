...
var passportLoader_1 = __importDefault(require("./passportLoader"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, dependencyInjection_1.default()];
            case 2:
                _a.sent();
                console.log("Dependencies injected");
                return [4 /*yield*/, expressLoader_1.default(app)];
            case 3:
                _a.sent();
                console.log("express loaded");
                return [4 /*yield*/, passportLoader_1.default(app)];
            case 4:
                _a.sent();
